...
exports.updateDepartamento = exports.deleteDepartamemto = exports.getDepartamento = exports.createDepartamento = exports.getDepartamentos = void 0;
const database_1 = require("../bd/database");
// instanciar la clase coneccion
const conection = new database_1.Coneccion();
// controlador de getdepartamentos (funcion o logica de la peticion)
...
function createDepartamento(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const conn = yield conection.getConneccion();
            const departamentos = yield conn.query("INSERT INTO departamento SET ?", [
                modDepartamento,
            ]);
            res.json({
...
// eliminar un departamento mediante su id
function deleteDepartamemto(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const id = req.params.departamentoId;
...
exports.deleteDepartamemto = deleteDepartamemto;
...
function updateDepartamento(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const modDepartamento = req.body;
        const conn = yield conection.getConneccion();
        yield conn.query("UPDATE departamento set ? WHERE id = ?", [
            modDepartamento,
            id,
        ]);
        res.json({
