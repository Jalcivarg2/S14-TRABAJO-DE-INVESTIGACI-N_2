...
// rutas de cargos con "/"
router.route("/").get(cargo_controller_1.getCargos).post(cargo_controller_1.createCargo);
// rutas de cargos con un id "/:cargoId"
router.route("/:cargoId").get(cargo_controller_1.getCargo).delete(cargo_controller_1.deleteCargo).put(cargo_controller_1.updateCargo);
